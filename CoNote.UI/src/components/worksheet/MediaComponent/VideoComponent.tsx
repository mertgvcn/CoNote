...
const VideoComponent = ({
  ...
  useEffect(() => {
    ...
    if (iframe) {
      iframe.setAttribute("width", `${component.width}`);
      iframe.setAttribute("height", `${component.height - 24}`);
    }
  }, [component.width, component.height, editor]);
  ...
  }, [editor, component.width, component.height, handleChange]);
